  ...
  return (
    <div className={`w-[100vw] md:w-screen panel flex flex-col-reverse xl:flex-row items-center text-white text-4xl ${bgColor} md:p-8`}>
      ...
      <div className={`w-auto h-auto ${textColor} xl:w-[50%] max-xl:w-[80%] max-md:w-[90%] max-md:my-4`} ref={detailsRef}>
        <h3 className="font-bold max-md:text-[1.8rem] mona-sans-font md:m-4">
          {project.title}
        </h3>
        <h3 className="text-gray-500 max-md:text-[1.5rem] font-bold md:m-4 mona-sans-font underline">
          Description:
        </h3>
        <div className="mona-sans-font md:ml-4 xl:text-2xl max-md:text-[18px] max-lg:text-xl max-xl:text-3xl max-md:leading-[25px] mx-auto">
